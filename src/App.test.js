...
fixture`Getting Started`.page`http://localhost:3000/Jeevan`;
...
test("Submit form with all fields filled", async (t) => {
  ...
  await t
    ...
    .click("#submit")
    .expect(Selector("#success").innerText)
    .eql("Registration request submitted successfully");
});
